...
const ProjectDetail = () => {
  ...
  const { developer } = useDeveloper(); // قد يكون null إذا كنا في صفحة عامة
  ...
  useEffect(() => {
    ...
    // جلب المشروع من قاعدة البيانات مباشرة (بدون الاعتماد على context)
    const fetchProject = async () => {
      try {
        // يمكن استخدام projectService.getById(id) إذا كان موجوداً
  ...
  return (
    <div className="min-h-screen bg-[#030014] px-[2%] sm:px-0 relative overflow-hidden">
      {/* خلفية متحركة (نفس التصميم القديم) */}
      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            ...
            {/* العمود الأيمن: صورة المشروع + الميزات */}
