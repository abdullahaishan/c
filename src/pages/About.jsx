...
<Sparkles className="w-5 h-5 text-purple-400" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            <h3 className="text-3xl font-bold text-white">
              ...
              <span className="block mt-2">{developer.full_name}</span>
            </h3>
            ...
            {/* <div className="flex gap-3 pt-4">
              {usedLinks.github && <a href={usedLinks.github} ...><Github .../></a>}
              {usedLinks.linkedin && <a href={usedLinks.linkedin} ...><Linkedin .../></a>}
              {usedLinks.instagram && <a href={usedLinks.instagram} ...><Instagram .../></a>}
              {usedLinks.facebook && <a href={usedLinks.facebook} ...><Facebook .../></a>}
            </div> */}
          </div>
        ...
        <div className="mt-8 p-4 bg-green-500/10 border border-green-500/20 rounded-lg text-center">
          <p className="text-green-500">
            ✅ وضع التشخيص: جميع الاستيرادات معطلة - المكون يعمل بشكل آمن
          </p>
        </div>
      </div>
    </div>
