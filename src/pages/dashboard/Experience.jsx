...
const Experience = () => {
  const { developer, getExperience, refresh } = useDeveloper()
  const { checkLimit, limits } = usePlan()
  const [experiences, setExperiences] = useState(getExperience())
  ...
  const handleAddExperience = async () => {
    ...
    if (!checkLimit('experience', experiences.length)) {
      setError(`You've reached the maximum limit of ${limits.maxExperience} experiences`)
      return
    }
    ...
    try {
      ...
      const created = await experienceService.create(developer.id, experienceData)
  ...
  return (
    <div className="space-y-6">
      ...
      {checkLimit('experience', experiences.length) && (
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
          <h2 className="text-lg font-semibold text-white mb-4">Add New Experience</h2>
          ...
          <div className="space-y-4">
            ...
            {/* Achievements */}
            <div>
              <label className="block text-sm text-gray-400 mb-2">Key Achievements</label>
            ...
            <button
              ...
              disabled={loading || !newExperience.job_title || !newExperience.company}
      ...
      <div className="space-y-4">
        ...
        {experiences.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">Add your work experience to showcase your career</p>
          </div>
        )}
      </div>
    </div>
